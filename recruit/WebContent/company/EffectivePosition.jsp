...
%>
<!-- 
我发布的职业-有效职业：蓝桥软件学院 渭南师范二期-郝磊20170826
134,136,137,138需要填写编辑.刷新.下线.删除href 
-->
					...
					<dd>
						<form id="searchForm">
							...
							<ul class="reset my_jobs">
								<li data-id="149594"><c:forEach items="${pageinfo.list}"
										...
										<div>工作类型：${ p.jobCategory} 薪资范围： ${p.minSalary }-${p.maxSalary }
											工作经验： ${p.workName } 学历： ${p.eName } 工作地点：${p.workCity }</div>
										<div class="c9">发布时间：${p.strDate }</div>

										<div class="links">
											<a href="getPostById?id=${p.id }">编辑</a> <a
												href="updateOnline?online=0&id=${p.id }">下线</a> <a
												class="job_del"
												href="delete?online=${p.online }&id=${p.id }">删除</a> <a
												class="refresh" id=${p.id }>刷新</a>
										</div>
									</c:forEach></li>
							</ul>
						</form>
						...
						<c:if test="${empty pageinfo.list }">
							<div class="container" style="height: 500px;width: 744px">
								<!-- <a href="company/post.jsp" style="font-size: 30px">还没有职位，点击添加新职位哟</a> -->
								<img alt="您还没有添加新职位哦" src="imags/null2.jpg" height="500px" width="700px">
							</div>
	...
	<div id="footer">
		<div class="wrapper">
			<a rel="nofollow" target="_blank"
				href="http://lanqiao.org/about.html">联系我们</a> <a target="_blank"
				href="http://www.lanqiao.org">互联网公司导航</a> <a rel="nofollow"
				target="_blank" href="http://weibo.com/u/6080568972">蓝桥微博</a> <a
				rel="nofollow" href="javascript:void(0)" class="footer_qr">蓝桥微信<i></i></a>
