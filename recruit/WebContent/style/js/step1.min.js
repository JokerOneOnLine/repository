...
$(function() {
	...
	window.onbeforeunload = function() {
		...
		var a = [];
		$("#box_industry li.current").length > 2 ? alert("最多可选2") : ($("#box_industry li.current").each(function() {
			a.push($(this).text())
		}), "" == a.join() ? $("#select_industry").val("行业领域") : $("#select_industry").val(a.join()), $("#select_industry_hidden").val(a.join()), $("#box_industry").hide()), $("#box_industry").hide(), $("#box_scale").hide(), $("#stagesList .box_invest").hide()
		...
		$(this).hasClass("current") ? ($(this).removeClass("current"), $("#box_industry li.current").each(function() {
			...
			b.push($(this).text())
		}), $("#select_industry").val(b.join()), $("#select_industry_hidden").val(b.join()), $("#box_industry").hide()) : $(this).siblings("li.current").length >= 2 && alert("最多可选2项"), $("#stepForm").validate().element("#select_industry_hidden")
