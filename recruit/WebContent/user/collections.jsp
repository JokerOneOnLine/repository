			...
			<div class="clearfix">
						...
						<dd>
							<form id="collectionsForm">
								<ul class="reset my_collections">
									<li data-id="133340"><a title="蓝桥软件学院" target="_blank"
										href="http://online.lanqiao.org/home.html"> <img alt="蓝桥软件学院"
											src="style/images/ff808081441c19bf01441f9a47190b3a.png">
									</a>
										<div class="co_item">
											<h2 title="蓝桥助理老师">
												<a target="_blank" href="http://online.lanqiao.org/home.html"> <em>蓝桥助理老师</em>
													<span>（4k以上）</span>
												</a>
											</h2>
											<span class="co_time">发布时间：2017-09-18 09:37</span>
											<div class="co_cate">蓝桥软件学院 / 北京 / 1-3年 / 本科</div>
											<span class="co_youhuo c7">出勤福利</span> <a
												class="collection_link" target="_blank" href="https://www.zhipin.com/gongsi/r111622.html">投个简历</a>
											<i></i> <a class="collectionCancel collection_link collected"
												href="javascript:;"> 取消收藏 <span>已取消收藏</span>
											</a>
										</div></li>
									<li data-id="148886"><a title="渭南师范" target="_blank"
										href="http://www.wntc.edu.cn/"> <img alt="渭南师范"
											src="style/images/ff80808142a8df050142b1674c596676.jpg">
									</a>
										<div class="co_item">
											<h2 title="PHP">
												<a target="_blank" href="http://www.wntc.edu.cn/"> <em>计算机教授</em>
													<span>（15k-30k）</span>
												</a>
											</h2>
											<span class="co_time">发布时间：2014-07-01 09:41</span>
											<div class="co_cate">渭南师范学院 / 杭州 / 不限 / 本科</div>
											<span class="co_youhuo c7">有技术挑战、有成长机会、有漂亮妹子</span> <a
												class="collection_link" target="_blank"
												href="http://job.wnu.edu.cn/">投个简历</a> <i></i> <a
												class="collectionCancel collection_link collected"
												href="javascript:;"> 取消收藏 <span>已取消收藏</span>
											</a>
										</div></li>
									<li data-id="148519"><a title="搜狗" target="_blank"
										href="https://www.sogou.com/"> <img alt="搜狗"
											src="style/images/ff80808142e0968f0142e0d41f1205f2.jpg">
									</a>
										<div class="co_item">
											<h2 title="商家运营">
												<a target="_blank" href="https://www.sogou.com/"> <em>商家运营</em>
													<span>（8k-16k）</span>
												</a>
											</h2>
											...
											<a class="collection_link" target="_blank" href="http://jobs.sogou.ourats.com/">投个简历</a> <i></i> 
											<a class="collectionCancel collection_link collected" href="javascript:;"> 取消收藏 <span>已取消收藏</span></a>
										</div></li>
								</ul>
							</form>
						</dd>
				...
				<div class="content_r">
					...
					<div class="mycenterR" id="resumeSet">
						<h2>我的投递</h2>
						<a target="_blank" href="user/delivery.jsp" class="preview_resume">投递箱</a>
					</div>
					<!--end #resumeSet-->
